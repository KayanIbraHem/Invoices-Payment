...
@endif
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('invoices.statusUpdate',['invoice'=>$invoice->id])}}" method="post" autocomplete="off">
                        @csrf
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                <label>تاريخ الفاتورة</label>
                                    <input type="text" class="form-control" id="inputName" name="invoice_date"
                            ...
                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                    <input type="text" class="form-control" id="inputName" name="due_date"
